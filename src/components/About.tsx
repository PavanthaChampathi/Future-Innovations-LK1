    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">About Future Innovations LK</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Premium Materials</h3>
            <div className="mb-6">
              <div className="flex items-center space-x-2 mb-4">
                <Star className="h-5 w-5 text-yellow-500" />
                <span className="font-semibold text-gray-900">High-Quality eSUN Filaments</span>
              </div>
            ...
            <div className="space-y-4">
              {materials.map((material, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4 hover:border-blue-200 transition-colors duration-300">
            ...
            <div className="mt-8 p-6 bg-blue-50 rounded-xl">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <h4 className="font-semibold text-gray-900">Located in Sri Lanka</h4>
              </div>
